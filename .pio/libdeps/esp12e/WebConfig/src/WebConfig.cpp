...
const char HTML_START[] PROGMEM =
  ...
  */
    ...
    //"<div class='title'>Konfiguracja SDMoto</div>\n"
    "<h2>Konfiguracja SDMoto</h2>\n"
    "<hr/>\n"
    "<form method='post'>\n";

//Template for one input field
const char HTML_ENTRY_SIMPLE[] PROGMEM =
    //"<div class='item' data-toggle='tooltip' data-placement='right' title='Help!'><b>%s</b></div>\n"
	"<div class='item'><b>%s</b></div>\n"
    //"<div class='item title='Pomoc&#13;dotycząca&#13;tej pozycji''><input type='%s' value='%s' name='%s'></div>\n";
